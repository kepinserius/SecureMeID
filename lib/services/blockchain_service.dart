...
class BlockchainService extends ChangeNotifier {
  ...
  final String _rpcUrl =
      'https://mainnet.infura.io/v3/YOUR_INFURA_KEY'; // Replace in production
  final String _wsUrl =
      'wss://mainnet.infura.io/ws/v3/YOUR_INFURA_KEY'; // Replace in production
  ...
  Future<String> storeDocument({
    ...
    try {
      ...
      final userDocuments =
          _simulatedBlockchain[userAddress] as Map<String, dynamic>;
  ...
  Future<bool> verifyDocument({
    ...
    try {
      ...
      documentData['verificationTimestamp'] =
  ...
  Future<bool> addTrustedContact({
    ...
    try {
      ...
      final trustedContacts =
          _simulatedBlockchain['trustedContacts'] as Map<String, dynamic>;
  ...
  Future<String> requestRecovery({
    ...
    try {
      ...
      final recoveryRequests =
          _simulatedBlockchain['recoveryRequests'] as Map<String, dynamic>;
